    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <section className="bg-blue-50/50 py-16 md:py-24 border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 animate-fadeInUp">Departments</h1>
          <p className="text-gray-500 text-lg md:text-xl max-w-2xl leading-relaxed animate-fadeInUp">
                  ...
                  <div className="absolute inset-0 p-10 flex flex-col justify-between">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <h2 className="text-4xl md:text-5xl font-black text-white">{category.name}</h2>
      ...
      <section className="bg-gray-50 py-20 mx-4 md:mx-8 rounded-[4rem]">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <button onClick={() => onCategorySelect('')} className="bg-slate-900 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:bg-blue-600 transition-all hover:scale-105 shadow-xl">Browse All Products</button>
        </div>
      </section>
    </div>
  );
